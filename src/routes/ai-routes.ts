/*
 * @Author: Diana Tang
 * @Date: 2025-03-13 17:48:00
 * @LastEditors: Diana Tang
 * @Description: AI 相关接口路由
 * @FilePath: /AI-Health-News-Agent-Back/src/routes/ai-routes.ts
 */
import { Router, Request, Response, NextFunction } from 'express';
// import { getAllNews } from '../services/fetchNewsWithPuppeteer';
import { getAllNews } from "../services/getAllNews";
import {AI_SOURCE} from '../services/config'
...
router.all("/ai_news", (req: Request, res: Response, next: NextFunction) => {
  (async () =>{
    try {
      ...
      let newsData = await getAllNews(AI_SOURCE);
